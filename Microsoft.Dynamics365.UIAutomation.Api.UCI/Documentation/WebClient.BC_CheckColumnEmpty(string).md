...
## WebClient.BC_CheckColumnEmpty(string) Method

Throws NoSuchElementException if specified column is not completely empty.

```csharp
internal Microsoft.Dynamics365.UIAutomation.Browser.BrowserCommandResult<bool> BC_CheckColumnEmpty(string columnName);
```
#### Parameters

<a name='Microsoft.Dynamics365.UIAutomation.Api.UCI.WebClient.BC_CheckColumnEmpty(string).columnName'></a>
