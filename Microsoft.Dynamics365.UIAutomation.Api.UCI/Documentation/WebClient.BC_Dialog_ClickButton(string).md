...
## WebClient.BC_Dialog_ClickButton(string) Method

Clicks a specified button on a dialog window.

```csharp
internal Microsoft.Dynamics365.UIAutomation.Browser.BrowserCommandResult<bool> BC_Dialog_ClickButton(string buttonName);
```
#### Parameters

<a name='Microsoft.Dynamics365.UIAutomation.Api.UCI.WebClient.BC_Dialog_ClickButton(string).buttonName'></a>
