...
## WebClient.BC_ClickMenu(string) Method

Clicks the specified menu button.

```csharp
internal Microsoft.Dynamics365.UIAutomation.Browser.BrowserCommandResult<bool> BC_ClickMenu(string menuTitle);
```
#### Parameters

<a name='Microsoft.Dynamics365.UIAutomation.Api.UCI.WebClient.BC_ClickMenu(string).menuTitle'></a>
