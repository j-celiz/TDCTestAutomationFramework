...
## WebClient.BC_ApplyVendorEntry(string) Method

Applies Vendor Entry for the row with the provided Document No.

```csharp
internal Microsoft.Dynamics365.UIAutomation.Browser.BrowserCommandResult<bool> BC_ApplyVendorEntry(string documentNo);
```
#### Parameters

<a name='Microsoft.Dynamics365.UIAutomation.Api.UCI.WebClient.BC_ApplyVendorEntry(string).documentNo'></a>
